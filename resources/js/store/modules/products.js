...
export default {
    ...
    getters: {
      loadingProducts: state => { return state.loading },
      currentSingleProductId: state => { return state.currentSingleProductId },
      currentProductId: state => { return state.currentProductId },
    //   currentProduct: state => { return (state.currentProductId != null) ? Product.find(state.currentProductId) : null },
      ...
      currentProduct: (state, getters, rootState, rootGetters) => {
        return (state.currentProductId != null && getters.products != null) ? getters.products.find(x => x.id == state.currentProductId) : null
      },
    },
