    ...
    <div class="team-users-table">
        ...
        <BaseContextMenu ref="contextMenuSelectedUsers">
            ...
            <template v-slot="slotProps">
                ...
                <div class="item-group">
                    <BaseContextMenuItem iconClass="far fa-trash-alt" hotkey="KeyD" @click="onRemoveUsersFromTeam">
        ...
        <BaseSelectButtonsContextMenu
            ...
            @submit="
                addUsersToTeam({ team, users: usersToAdd })
                usersToAdd = []
            "
            @cancel="usersToAdd = []"
        />
...
export default {
    ...
    computed: {
        ...
        availableUsers() {
            ...
            return allUsers
                .filter(workspaceUser => !this.team.users.find(teamUser => teamUser.id == workspaceUser.id))
                .sort((a, b) => {
