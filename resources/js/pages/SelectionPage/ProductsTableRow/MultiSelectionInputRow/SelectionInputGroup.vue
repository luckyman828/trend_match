<template>
    <div
        class="selection-input-group"
        v-if="selectionInput"
        tabindex="0"
        ref="selectionInputGroup"
        @keyup="keypressHandler($event)"
    >
        <span class="name" v-tooltip="selection.name.length > 18 ? selection.name : ''" @click="onViewSingle">
        ...
        <div class="selection-action-buttons">
            ...
            <div class="selection-action">
                ...
                <div
                    v-tooltip-trigger="{ tooltipRef: distributionTooltipRef, showArg: { selectionInput, type: 'In' } }"
                >
                    {{
                        distributionScope == 'Alignment'
            ...
            <div class="selection-action">
                ...
                <div
                    v-tooltip-trigger="{ tooltipRef: distributionTooltipRef, showArg: { selectionInput, type: 'Out' } }"
                >
                    {{
                        distributionScope == 'Alignment'
...
export default {
    ...
    methods: {
        ...
        keypressHandler(event) {
            ...
            if (key == 'Enter') this.onViewSingle()
