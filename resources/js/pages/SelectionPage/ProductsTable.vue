<template>
    <div class="products card" :class="[{sticky: sticky}]">
        ...
        <BaseFlyin ref="singleFlyIn" :show="singleVisible" @close="setSingleVisisble(false)">
            <ProductFlyin v-if="currentProduct" :loading="loadingSingle" :authUser="authUser" :visible="singleVisible" @closeSingle="onCloseSingle" @onToggleInOut="toggleInOut"/>
        </BaseFlyin>
        <div class="flex-table">
            ...
            <template v-if="!loading">
                ...
                >
                    ...
                    @onViewSingle="onViewSingle" @onSelect="onSelect" @toggleInOut="toggleInOut" :selectedProducts="selectedProducts"/>
                </RecycleScroller>
