<template>
    <div class="user-wrapper" :class="status">
        <div class="info" v-if="existsOnApp" v-tooltip="'User is already added and will be ignored.'">
            <i class="far fa-info-circle"></i>
            <span>Already added</span>
        </div>
        <template v-else-if="emailValidated && !existsOnKollekt">
            <div class="info" v-tooltip="`This user's name and password will not be updated.`">
                <i class="far fa-info-circle"></i>
                <span>This user does not exist on Kollekt yet. Give them a name and password.</span>
            </div>
        </template>
        ...
        <template v-if="emailValidated && !existsOnKollekt">
            <div class="form-element">
...
export default {
    ...
    computed: {
        ...
        status() {
            ...
            if (this.existsOnApp) return 'warning'
