<template>
    <div class="products card" :class="[{sticky: sticky}]">
        ...
        <FlyIn :visibleOverwrite="singleVisible" @close="onCloseSingle">
            <EditProductSingle :visible="singleVisible" @closeSingle="onCloseSingle"/>
        </FlyIn>
...
import EditProductSingle from './EditProductSingle'
