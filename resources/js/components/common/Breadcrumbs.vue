<template>
    <div class="breadcrumbs">
        <button class="no-bg ghost-hover sm" @click="onGoToHome">
        ...
        <div class="breadcrumb" v-for="(folder, index) in getCurrentFilePath" :key="folder.id">
            <template v-if="!currentFolder || folder.id != currentFolder.id">
                <button @click="setCurrentFolder(folder, index)" class="no-bg ghost-hover sm">
            ...
            <template v-else>
                <button class="no-bg ghost-hover sm">
