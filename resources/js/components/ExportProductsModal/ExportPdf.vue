        ...
        <div class="wrapper" ref="pdfWrapper">
            <div class="inner" style="font-family: 'Roboto', sans-serif, helvetica, arial; position: relative;">
                ...
                box-sizing: border-box; padding: 60px 38px 38px; position: relative;">
                    ...
                    <ProductListItem v-for="product in productChunk" :key="product.id" 
                    :index="index" :product="product"
                    :includeVariants="includeVariants" :exportComments="exportComments"
                    :includeDistribution="includeDistribution" :includeNotDecided="includeNotDecided"/>
