<template>
    <div class="edit-file-component">
      <EditFileHeader :file="collection"/>
        ...
        <EditProductsTable :products="productsFilteredv1" :totalProductCount="productsRaw.length" :selectedIds="selectedProductIDs" :sortBy="sortBy" :sortAsc="sortAsc" @onSortBy="onSortBy" @onSelect="setSelectedProduct"/>
