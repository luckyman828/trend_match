...
var contentWindow = Object(_play_js__WEBPACK_IMPORTED_MODULE_1__["embed"])(addToBasket, removeFromBasket);
...
/***/ "./resources/js/public-scripts/play.js":
/*!*********************************************!*\
  !*** ./resources/js/public-scripts/play.js ***!
  \*********************************************/
...
function embed(addToBasketCallBack, removeFromBasketCallback) {
  // Kollekt PLAY
  var version = "0.0.0 - (6)";
  console.log('Init PLAY embed script. Version: ' + version); // Create Player

  var playerEl = document.createElement('div');
  playerEl.style.cssText = 'position: fixed; left: 0; top: 0; height: 100vh; width: 100vw; z-index: 99999; display: none; min-height: 100vh;min-width: 100vw;max-height: 100vh;overflow: hidden;background: #f4f6ff;scroll-behavior: smooth;min-height: -webkit-fill-available;height: -webkit-fill-available;'; // Close button
  ...
  iframeEl.id = "embed-".concat(version);
  ...
  document.body.appendChild(playerEl); // Add click listener

  document.addEventListener('click', function (e) {
    var button = e.target.getAttribute('data-kollekt-play-id') ? e.target : e.target.closest('[data-kollekt-play-id]');

    if (!button) {
      return;
    }

    var presentationId = button.getAttribute('data-kollekt-play-id');
    var iFrameBaseUrl = 'https://dev-stable.kollekt.dk/#/play/watch/'; // const iFrameBaseUrl = 'https://kollekt_feature.test/#/play/watch/'
    // iframeEl.src = `${iFrameBaseUrl}${videoId}`
    // iframeEl.src = `https://kollekt_feature.test/#/?timestamp=${new Date().getTime()}`

    iframeEl.src = "".concat(iFrameBaseUrl).concat(presentationId, "?timestamp=").concat(new Date().getTime());
  ...
  window.addEventListener('message', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event) {
      var testOrigins, acceptedOrigins, msgData;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              testOrigins = [];
              acceptedOrigins = ['https://app.kollekt.dk', 'https://branchtest.kollekt.dk', 'https://dev.kollekt.dk', 'https://dev-stable.kollekt.dk', 'https://staging.kollekt.dk'];

              if ([].concat(testOrigins, acceptedOrigins).includes(event.origin)) {
                _context.next = 4;
                break;
              }
            ...
            case 4:
              msgData = event.data; // ADD TO BASKET
...
/***/ 4:
/*!*******************************************************************************************************************************************!*\
  !*** multi ./resources/js/public-scripts/play-dkc.js ./resources/js/public-scripts/play-shopify.js ./resources/js/public-scripts/play.js ***!
  \*******************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\laragon\www\kollekt_feature\resources\js\public-scripts\play-dkc.js */"./resources/js/public-scripts/play-dkc.js");
__webpack_require__(/*! C:\laragon\www\kollekt_feature\resources\js\public-scripts\play-shopify.js */"./resources/js/public-scripts/play-shopify.js");
module.exports = __webpack_require__(/*! C:\laragon\www\kollekt_feature\resources\js\public-scripts\play.js */"./resources/js/public-scripts/play.js");
